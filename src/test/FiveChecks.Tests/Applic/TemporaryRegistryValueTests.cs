...
namespace FiveChecks.Tests.Applic
{
    ...
    public class TemporaryRegistryValueTests
    {
        ...
        {
            new object[ ]{"Different value kind. Return error result.",new TestData("SomeTestValueName","SomeTestValue",RegistryValueKind.String, 0, RegistryValueKind.DWord, IsSuccess.False, "The existing registry value '[HKEY_CURRENT_USER\\FiveChecks.Tests]SomeTestValueName' has different value kind: 'DWord!=String'\r\nParameter name: valueKind", GetValueCallCount.One, GetValueKindCallCount.One, SetValueCallCount.Zero, DeleteValueCallCount.Zero)}, 
