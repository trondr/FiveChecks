...
namespace Compliance.Notifications.Tests.Applic.Commands
{
    ...
    public class CheckPasswordExpiryCommandTests
    {
        ...
        public void IsDisabledTest()
        {
            ...
            Assert.AreEqual(true, actual, @"Value is not set: [HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Policies\FiveChecks\Compliance.Notifications\PasswordExpiryCheck]Disabled=1");
        }
    }
}