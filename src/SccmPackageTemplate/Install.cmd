...
@REM ================================================================================================
"%WinSysDir%\msiexec.exe" /i "%~dp0%MsiFileName%" ADDLOCAL=ALL ALLUSERS=1 REBOOT=ReallySuppress ARPCOMMENTS="Installed by FiveChecks" /qn /l*v "%LOGDIR%\%MsiFileName%-install.log"
